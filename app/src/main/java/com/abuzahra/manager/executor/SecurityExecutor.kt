...
object SecurityExecutor {
    ...
    fun showApp(context: Context): String {
        return try {
            ...
            val componentName = android.content.ComponentName(context, "com.abuzahra.manager.MainActivity")
    ...
    fun deviceAdminStatus(context: Context): Map<String, Any> {
        return try {
            ...
            val isAdmin = dpm.isAdminActive(android.content.ComponentName(context, "com.abuzahra.manager.service.DeviceAdminReceiver"))
            mapOf<String, Any>(
            ...
            mapOf<String, Any>("error" to (e.message ?: ""))
        }
    }
